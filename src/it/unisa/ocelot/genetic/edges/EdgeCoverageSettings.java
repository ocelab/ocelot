...
public class EdgeCoverageSettings extends Settings {
	...
	public EdgeCoverageSettings(EdgeCoverageProblem pProblem) {
		super();
	...
	public EdgeCoverageSettings(EdgeCoverageProblem pProblem, ConfigManager pConfig) {
		this(pProblem);
