...
public class ManyNodesCoverageProblem extends StandardProblem {
	...
	public ManyNodesCoverageProblem(CFG pCfg, CType[] pParameters, Range<Double>[] pRanges, int pArraySize) throws Exception {
		super(pParameters, pRanges, pArraySize);
		this.cfg = pCfg;
		problemName_ = "PathCoverageProblem";
	}

	public ManyNodesCoverageProblem(CFG pCfg, CType[] pParameters, int pArraySize) throws Exception {
	...
	public void setTarget(List<CFGNode> pTargetNodes) {		
	...
	public void evaluateSolution(Solution solution) throws JMException, SimulationException {
		...
		ManyNodesDistanceListener listener = 
				new ManyNodesDistanceListener(this.cfg, this.targetNodes, this.fixedApproachLevels, this.dominators);
