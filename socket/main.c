...
#define EMSGSLEN 100
#define EMSGSNUM 100
#define MAX_NUM_OF_SUPGRPS 5
#define MOSEMSGSNUM 20
#define MOSEMSGSLEN 100
...
#define ADD_TYPE 0
#define REM_TYPE 1
#define LIN_GRID_X_ORIENT 0
#define LIN_GRID_Y_ORIENT 1
...
#define DEF_ROTATION_DIRECTION CW_ROTATION
...
int recgrdef(struct charac *p1, struct charac **pp2, double *pstep_ptr, double *qstep_ptr, int *pqstep_unit_ptr);
int hexgrdef(struct charac *p1, struct charac **pp2, double *pstep_ptr, int *pstep_unit_ptr);
int trigrdef(struct charac *p1, struct charac **pp2, double *angle_ptr, int *angle_unit_ptr, double *pstep_ptr, double *qstep_ptr, int *pqstep_unit_ptr, double *px_ptr, double *py_ptr, double *qx_ptr, double *qy_ptr, int *pqxy_unit_ptr);
int griddef1(struct charac *p1, struct charac **pp2, struct Grid **grid_ptr);
int doubstep(struct charac *p1, struct charac **pp2, double *pstep_ptr, double *qstep_ptr, int *pqstep_unit_ptr);
int angclaus(struct charac *p1, struct charac **pp2, double *angle_ptr, int *angle_unit_ptr);
int angstep(struct charac *p1, struct charac **pp2, double *angle_ptr, int *angle_unit_ptr, double *pstep_ptr, double *qstep_ptr, int *pqstep_unit_ptr);
int versdef(struct charac *p1, struct charac **pp2, double *px_ptr, double *py_ptr, double *qx_ptr, double *qy_ptr, int *pqxy_unit_ptr);
int sinstep(struct charac *p1, struct charac **pp2, double *step_ptr, int *step_unit_ptr);
int recspec(struct charac *p1, struct charac **pp2, double *pdim_ptr, double *qdim_ptr, int *pqdim_unit_ptr);
int geomspec(struct charac *p1, struct charac **pp2, int *geometry_ptr, double *radius_ptr, int *radius_unit_ptr, double *pdim_ptr, double *qdim_ptr, int *pqdim_unit_ptr);
...
int gaussel(struct charac *p1, struct charac **pp2, double *anglee_ptr, double *angleh_ptr, int *angle_unit_ptr, double *tapere_ptr, double *taperh_ptr, int *taper_unit_ptr);
int cosinus(struct charac *p1, struct charac **pp2, double *exp_ptr);
int modspec(struct charac *p1, struct charac **pp2, int *model_ptr, double *exp_ptr, double *anglee_ptr, double *angleh_ptr, int *angle_unit_ptr, double *tapere_ptr, double *taperh_ptr, int *taper_unit_ptr);
int angval(struct charac *p1, struct charac **pp2, double *angle_ptr, int *angle_unit_ptr);
int polor(struct charac *p1, struct charac **pp2, double *phiangle_ptr, int *phiangle_unit_ptr);
...
int polspec(struct charac *p1, struct charac **pp2, int *polarization_ptr, double *phepol_ptr, int *phepol_unit_ptr, int *direction_ptr);
...
int nodorien(struct charac *p1, struct charac **pp2, double *theta_ptr, double *phi_ptr, double *psi_ptr, int *angle_unit_ptr);
...
int secoramp(struct charac *p1, struct charac **pp2, double *centre_ptr, double *p1_et_ptr, double *p2_et_ptr, double *q1_et_ptr, double *q2_et_ptr, int *amp_unit_ptr);
...
int angledir(struct charac *p1, struct charac **pp2, double *theta_ptr, double *phi_ptr, int *angle_unit_ptr);
...
int beampha(struct charac *p1, struct charac **pp2, double *u_ptr, double *v_ptr, double *theta_ptr, double *phi_ptr, int *angle_unit_ptr);
int phaserot(struct charac *p1, struct charac **pp2, double *phase_start_ptr, double *phase_step_ptr, int *phase_unit_ptr);
int anglerot(struct charac *p1, struct charac **pp2, double *angle_start_ptr, double *angle_step_ptr, int *angle_unit_ptr);
int serotdir(struct charac *p1, struct charac **pp2, int *direction_ptr);
int serotpar(struct charac *p1, struct charac **pp2, double *angle_start_ptr, double *angle_step_ptr, int *omit_phase_ptr, double *phase_start_ptr, double *phase_step_ptr, int *angle_unit_ptr, int *phase_unit_ptr);
int serotpha(struct charac *p1, struct charac **pp2, int *direction_ptr, int *omit_angle_ptr, double *angle_start_ptr, double *angle_step_ptr, int *omit_phase_ptr, double *phase_start_ptr, double *phase_step_ptr, int *angle_unit_ptr, int *phase_unit_ptr);
int secorpha(struct charac *p1, struct charac **pp2, double *centre_ptr, double *p1_ep_ptr, double *p2_ep_ptr, double *q1_ep_ptr, double *q2_ep_ptr, int *phase_unit_ptr);
...
int grexcdef(struct charac *p1, struct charac **pp2, struct GrAmpExc **grampexc_ptr, struct GrPhaExc **grphaexc_ptr);
...
int mksnode(struct AddRem *addrem_ptr, struct Geomnode **first_node_ptr, struct Geomnode **last_node_ptr, double pstep, double qstep, double angle, int *nodes_num_ptr, int elem_shape, double elem_pdim, double elem_qdim);
int mksblock(struct AddRem *addrem_ptr, struct Geomnode **first_node_ptr, struct Geomnode **last_node_ptr, double pstep, double qstep, double angle, int *nodes_num_ptr, int elem_shape, double elem_pdim, double elem_qdim);
int mkshex(struct AddRem *addrem_ptr, struct Geomnode **first_node_ptr, struct Geomnode **last_node_ptr, double pstep, double qstep, double angle, int *nodes_num_ptr, int elem_shape, double elem_pdim, double elem_qdim);
...
int extsize(struct Geomnode *gnode_ptr, double elem_pdim, double elem_qdim, double *xsize_ptr, double *ysize_ptr);
...
int sgrampun(struct GrAmpExc *grampexc_ptr, struct Geomnode *gnode_ptr, struct Port *port_ptr);
int simamp(struct Group *group_ptr);
int pqlimits(struct Geomnode *gnode_ptr, struct Geomnode **pmin_ptr, struct Geomnode **pmax_ptr, struct Geomnode **qmin_ptr, struct Geomnode **qmax_ptr);
int sgramp2n(struct GrAmpExc *grampexc_ptr, struct Geomnode *gnode_ptr, struct Port *port_ptr, int group_shape);
double secorder(double a, double b, double c, double d, double e, double x, double y);
...
int sgrpha2n(struct GrPhaExc *grphaexc_ptr, struct Geomnode *geomnode_ptr, struct Port *port_ptr, int group_shape);
int gnodfind(struct Geomnode *gnode_list_start_ptr, struct Geomnode **gnode_ptr, int p, int q);
void gnodevis(int p, int q, double angle, double phase, struct Geomnode *gnode_list_start_ptr);
void seqrotrg(double angle_start, double angle_step, double phase_start, double phase_step, struct Geomnode *g);
void seqrothg(double angle_start, double angle_step, double phase_start, double phase_step, struct Geomnode *g);
...
*curr_ptr = *tp;
ch = TapeGet(curr_ptr);
while(((isalnum(ch)) || (ch == '_')) && (i < 20) && ((*curr_ptr) != NULL)){
    word[i] = ch;
    i = i + 1;
    ch = TapeGet(curr_ptr);
}
...
if(_f_ocelot_trace(error != 0, _f_ocelot_neq_numeric(error, 0), _f_ocelot_eq_numeric(error, 0))){
    return 1;
}
;
while(_f_ocelot_trace(1, _f_ocelot_istrue(1), _f_ocelot_isfalse(1))){
    error = nodecoor(*curr_ptr, curr_ptr, pcoord_ptr, qcoord_ptr);
    if(_f_ocelot_trace(error == 0, _f_ocelot_eq_numeric(error, 0), _f_ocelot_neq_numeric(error, 0))){
        cont = cont + 1;
        app_ptr = (struct Node*)malloc(sizeof (struct Node));
        if(_f_ocelot_trace(app_ptr == NULL, _f_ocelot_eq_pointer(app_ptr, NULL), _f_ocelot_neq_pointer(app_ptr, NULL))){
            parserro(*curr_ptr, 55, " ");
            interror("polydef()");
        }
        ;
        ...
        app_ptr->PSEA = 0;
        app_ptr->ANGLE_UNIT = 0;
        if(_f_ocelot_trace(primo_ptr == NULL, _f_ocelot_eq_pointer(primo_ptr, NULL), _f_ocelot_neq_pointer(primo_ptr, NULL))){
            primo_ptr = app_ptr;
            ultimo_ptr = app_ptr;
            app_ptr->NEXT = NULL;
        }else{
...
if(_f_ocelot_trace(cont < 3, _f_ocelot_lt_numeric(cont, 3), _f_ocelot_ge_numeric(cont, 3))){
    *node_ptr = NULL;
...
int sgramp2n(struct GrAmpExc *grampexc_ptr, struct Geomnode *geomnode_ptr, struct Port *port_ptr, int group_shape)
{
